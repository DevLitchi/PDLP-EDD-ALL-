...
// Ejercicio 8  de colas/pilas en las colas solo se agregan usuarios al final no hay en medio ni principio
// Programa para simular una fila de un banco con listas enlazadas y mostrar el turno de cada cliente
import java.util.Scanner;

public class Ejercicio8 {
    public static void main(String[] args) {
        Cola filaBanco = new Cola();
        ...
        do {
            ...
            System.err.println("| 3) Eliminar Inicio       |");
